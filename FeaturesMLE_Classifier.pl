...
foreach $Class(@Classes){
	...
	$ClassHits{$Class} = $StrainHits; # Number of hits for each class	
}
...
#######################################################
   ...
   #print "\n$ProbeClass{a}{A}
   #      $ProbeTotalHits{a} - $ProbeClass{a}{A}
   #      $Classes{$Class} - $ProbeClass{$Probe}{$Class}
   #      $N - $Classes{$Classes} - $ProbeTotalHits{$Probe} - $ProbeClass{$Probe}{$Class}";
   #exit;
